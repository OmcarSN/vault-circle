...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.memberIndex) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named memberIndex');
    }
    if (typeof(witnesses_0.memberContribution) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named memberContribution');
    }
    this.witnesses = witnesses_0;
    this.circuits = {
      joinCircle: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`joinCircle: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        const result_0 = this._joinCircle_0(context, partialProofData);
      ...
      contribute: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('contribute',
                                     'argument 1 (as invoked from Typescript)',
                                     'counter.compact line 54 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      checkSolvency: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`checkSolvency: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const result_0 = this._checkSolvency_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      getRotationStatus: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`getRotationStatus: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const result_0 = this._getRotationStatus_0(context, partialProofData);
        partialProofData.output = { value: _descriptor_1.toValue(result_0), alignment: _descriptor_1.alignment() };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      claimPayout: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`claimPayout: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const result_0 = this._claimPayout_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      markInsolvent: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`markInsolvent: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const result_0 = this._markInsolvent_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = {
      ...
      checkSolvency: this.circuits.checkSolvency,
      getRotationStatus: this.circuits.getRotationStatus,
      claimPayout: this.circuits.claimPayout,
      markInsolvent: this.circuits.markInsolvent
    };
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(reqShare_0) === 'bigint' && reqShare_0 >= 0n && reqShare_0 <= 4294967295n)) {
    ...
    state_0.setOperation('checkSolvency', new __compactRuntime.ContractOperation());
    state_0.setOperation('getRotationStatus', new __compactRuntime.ContractOperation());
    state_0.setOperation('claimPayout', new __compactRuntime.ContractOperation());
    state_0.setOperation('markInsolvent', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(0n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(reqShare_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = 0n;
    __compactRuntime.queryLedgerState(context,
  ...
  _memberIndex_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.memberIndex(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 4294967295n)) {
      __compactRuntime.typeError('memberIndex',
                                 'return value',
  ...
  _memberContribution_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.memberContribution(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 4294967295n)) {
      __compactRuntime.typeError('memberContribution',
                                 'return value',
  ...
  _joinCircle_0(context, partialProofData) {
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('counter.compact line 48 char 26: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
  ...
  _contribute_0(context, partialProofData) {
    const amount_0 = this._memberContribution_0(context, partialProofData);
  ...
  _checkSolvency_0(context, partialProofData) {
    let t_0;
    __compactRuntime.assert((t_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                             partialProofData,
                                                                                             [
  ...
  _getRotationStatus_0(context, partialProofData) {
    const idx_0 = this._memberIndex_0(context, partialProofData);
    return this._equal_0(idx_0,
                         _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                   partialProofData,
                                                                                   [
                                                                                    { dup: { n: 0 } },
  ...
  _claimPayout_0(context, partialProofData) {
    const idx_0 = this._memberIndex_0(context, partialProofData);
    __compactRuntime.assert(this._equal_1(idx_0,
                                          _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    partialProofData,
                                                                                                    [
                                                                                                     { dup: { n: 0 } },
                                        ...
                                        [
                                         { push: { storage: false,
                                                   value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(2n),
                                                                                                alignment: _descriptor_7.alignment() }).encode() } },
                                         { push: { storage: true,
                                                   value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(nextIdx_0),
                                                                                                alignment: _descriptor_0.alignment() }).encode() } },
                                         { ins: { cached: false, n: 1 } }]);
    }
    const tmp_1 = 0n;
  ...
  _markInsolvent_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                            ...
                            ===
                            true,
                            'Fund is already marked insolvent');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
...
export function ledger(stateOrChargedState) {
  ...
  return {
    ...
    get membersContributedThisCycle() {
      return _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                       partialProofData,
                                                                       [
                                                                        { dup: { n: 0 } },
...
const _dummyContract = new Contract({
  memberIndex: (...args) => undefined,
  memberContribution: (...args) => undefined
});
